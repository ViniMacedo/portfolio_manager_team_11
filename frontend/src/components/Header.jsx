...
import { Sparkles, Search, Bell, Settings } from 'lucide-react';

const Header = () => {
  return (
    <header className="relative z-10 w-full max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 py-1 sm:py-2">
      <div className="bg-white/10 backdrop-blur-sm rounded-xl p-2 sm:p-3 flex items-center justify-between border border-white/20 min-w-0">
