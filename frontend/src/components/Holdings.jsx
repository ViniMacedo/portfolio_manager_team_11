          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-white/90 text-lg font-medium">
                {portfolio.holdings.length} positions in your portfolio
              </p>
            </div>
        ...
        <div className="h-full overflow-y-auto p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {portfolio.holdings.map((stock) => {
              ...
              const avgPrice =
                stock.avg_price || stock.average_cost || currentPrice;

              const value = shares * currentPrice;
              const change = currentPrice - avgPrice;
              const changePercent =
                avgPrice > 0 ? ((change / avgPrice) * 100).toFixed(2) : "0.00";
              const colorClass =
                change >= 0
              ...
              return (
                ...
                >
                  <div className="flex flex-col space-y-3">
                    <div className="flex items-center justify-between">
                      <div
                        className={`w-10 h-10 bg-gradient-to-r ${colorClass} rounded-xl flex items-center justify-center text-white font-bold shadow-lg`}
                      >
                        {stock.symbol[0]}
                      </div>
                      <div className="text-right">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600 text-xs">
                        {stock.name || stock.product_type || "Stock"}
                      </div>
